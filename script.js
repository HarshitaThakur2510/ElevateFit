document.addEventListener('DOMContentLoaded', () => {
    ...
    const testimonials = [
        ...
        },
        {
            ...
            text: "I was new to the gym and intimidated, but ElevateFit created a welcoming and motivating environment. He taught me proper form and built a plan that made me fall in love with fitness."
        }
    ];
